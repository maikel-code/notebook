...
export const MAX_WEB_SEARCH_QUERY_CHARS = 200
export const MAX_WEB_SOURCE_BYTES = 1_048_576
export const MAX_WEB_REDIRECTS = 3
export const WEB_FETCH_TIMEOUT_MS = 10_000
export const MIN_ORIENTATION_QUESTIONS = 3
export const MAX_ORIENTATION_QUESTIONS = 5
export const MAX_SOURCE_OVERVIEW_CHARS = 800
